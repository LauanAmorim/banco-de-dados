...
insert into tbl_usuario
			values
			(default, "Orlindo Omiya", 'orlindo@gmail.com', 'omya2', 1, 'Rua Adamastor, 58', 'Santos', '05252-020'),
			(default, "Janailson Matias", 'matias@gmail.com', 'janass', 0, 'Rua Jaraguá, 128', 'São Paulo', '00881-220'),
			(default, "Olidio Junior", 'olidio@hotmail.com', 'etec20', 0, 'Rua Pompeia, 400', 'São Paulo', '05252-025');

/*
select * from tbl_livro;

select nM_lIvRo from vw_livro;
select * from vw_livro;


select nm_livro, vl_preco, ds_capa, qt_estoque from vw_livro where sg_lancamento = 'S';
*/